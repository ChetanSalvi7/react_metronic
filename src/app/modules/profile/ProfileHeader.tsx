...
import {DeleteIconButton} from "../../services/SweetAlerts";
                        ...
                        <div
                            ...
                            <div className='d-flex flex-column'>
                                ...
                                <div
                                    ...
                                    >
                                        <KTIcon iconName='profile-circle'
                                                className='fs-4 me-1'/>
                                        Developer
                                    </a>
                                    <a
                        ...
                        <div className='d-flex flex-wrap flex-stack'>
                                ...
                                <div className='d-flex flex-wrap'>
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div
                                                className='fs-2 fw-bolder'>4500$
                                            </div>
                                        </div>

                                        <div
                                            className='fw-bold fs-6 text-gray-400'>Earnings
                                        </div>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div className='fs-2 fw-bolder'>75
                                            </div>
                                        </div>

                                        <div
                                            className='fw-bold fs-6 text-gray-400'>Projects
                                        </div>
                                    </div>
                                        ...
                                        className='border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3'>
                                            <div
                                                ...
                                                <KTIcon iconName='arrow-up'
                                                        className='fs-3 text-success me-2'/>
                                                <div
                                                    className='fs-2 fw-bolder'>60%
                                                </div>
                                            </div>
                                        <div
                                            className='fw-bold fs-6 text-gray-400'>Success
                                            Rate
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <span
                                        className='fw-bold fs-6 text-gray-400'>Profile Compleation</span>
